package ru.rpuxa.bomjara2.cache;
        ...
        try {
            ...
            for (Field field : clazz.getDeclaredFields()) {
                ...
                if (Collection.class.isAssignableFrom(fieldClass)) {
                    ...
                    if (!collection.isEmpty()) {
                        ...
                        if (firstObject instanceof Serializable || firstObject.getClass().isPrimitive()) {
                            ...
                            for (Object obj : collection)
                                newCollection.add(((SuperSerializable) obj).serialize());
                    ...
                    final ToSerialize serializable = superSerializable.serialize();
